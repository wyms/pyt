...
canvas.bind("<B1-Motion>", draw)  # B1-Motion is the event for dragging the left mouse button
canvas.bind("<Button-1>", start_drawing)  # Button-1 is the event for pressing the left mouse button
canvas.bind("<ButtonRelease-1>", stop_drawing)  # ButtonRelease-1 is the event for releasing the left mouse button
